...
I'm built in python3, using the python-telegram-bot library, and am fully [Main Channel](https://t.me/HombaleCinemas) you can find what makes me tick \
[Support Group](https://t.me/HombaleCinemasChat)!

You can find the list of available commands with /help.

Using standard [support group](https://t.me/HombaleCinemasChat) is always gonna be easier.
Perks:
- latest features
- it's free
